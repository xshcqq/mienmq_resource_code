...
@MienMqListener(queueName = "DEFAULT_QUEUE")
public class MessagePullListener extends DefaultConsumer {
    private final static Logger logger = LoggerFactory.getLogger(MessagePullListener.class);
